      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {filteredAlumni.map((alumni) => (
            <Card key={alumni.id} className="group bg-white border border-gray-200 hover:border-blue-300 hover:shadow-lg rounded-xl overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    <div className="flex space-x-3">
                      {alumni.linkedin && (
                        <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center cursor-pointer hover:bg-blue-200">
                          <Linkedin className="h-4 w-4 text-blue-600" />
                        </div>
                      )}
                      {alumni.twitter && (
                        <div className="w-8 h-8 bg-sky-100 rounded-lg flex items-center justify-center cursor-pointer hover:bg-sky-200">
                          <Twitter className="h-4 w-4 text-sky-600" />
                        </div>
                      )}
                      {alumni.github && (
                        <div className="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-200">
        ...
        {filteredAlumni.length === 0 && (
          <div className="text-center py-16">
            <div className="w-24 h-24 bg-blue-500/10 rounded-xl flex items-center justify-center mx-auto mb-6">
              <Search className="h-12 w-12 text-blue-400" />
            </div>
            <p className="text-white text-xl mb-2">No alumni found</p>
